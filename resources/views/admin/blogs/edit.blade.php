...
@section('content')
    ...
    <div>
        <div class="container">
            <div class="top_title">
                <h3 class="text-center">Editar Blog</i> </h3>
            </div>
            ...
            <div class="row" id="dev-app" style="padding-top:120px;">
                ...
                <button style="display:none" @click="update()" id="create-click"></button>
            ...
            <div class="row">
                <div class="col-12">
                    <p class="text-center">
                        <button class="btn btn-success" onclick="create()">Actualizar</button>
                    </p>
                </div>
            </div>
            ...
            methods:{
                ...
                update(){
                    ...
                    if(this.description == ""){
                        ...
                        this.loading = true
                        axios.post("{{ url('admin/blogs/update') }}", {id: this.blogId, title:this.title, image: this.picture, description: this.description}).then(res => {
                        this.loading = false
